...
void read_X_R_Measurements (const string& filenameX, unsigned long N, unsigned short p,MatrixXd& X,const string& filenameR, unsigned m, MatrixXd& R,const string& filenameMeasurement, unsigned nMeasurementSets, MatrixXd& measurements);
